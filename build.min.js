...
var Na={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:B(!1,C),alternative_browser_fingerprint_id:B(!1,C),identity_id:B(!1,C),link_identifier:B(!1,1),sdk:B(!1,1),options:B(!1,0),initial_referrer:B(!1,1)}},Oa={destination:"https://qla7-maephet.branchbeta.link",endpoint:"/_r",method:"GET",U:!0,a:{sdk:B(!0,1),_t:B(!1,C),branch_key:B(!0,1)}},Pa={destination:"",endpoint:"",method:"GET",f:{link_url:B(!0,1)},a:{click:B(!0,1)}},Qa={destination:"https://maephet.link.beta.branch.io",
endpoint:"/c",method:"POST",f:{link_url:B(!0,1)},a:{sdk:B(!1,1),phone:B(!0,1)}},Ra={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:D({amount:B(!0,2),bucket:B(!1,1),calculation_type:B(!0,2),creation_source:B(!0,2),expiration:B(!1,1),location:B(!0,2),prefix:B(!1,1),type:B(!0,1)})},Sa={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",f:{code:B(!0,1)},a:D({})},Ta={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/applycode",
method:"POST",f:{code:B(!0,1)},a:D({})},Ua={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:D({session_id:B(!0,C)})},Va={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:D({identity_id:B(!0,C),identity:B(!0,1)})},Wa={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/referrals",method:"GET",f:{identity_id:B(!0,C)},a:D({})},Xa={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/credithistory",method:"GET",
a:D({begin_after_id:B(!1,C),bucket:B(!1,1),direction:B(!1,2),length:B(!1,2),link_click_id:B(!1,C)})},Ya={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:D({branch_key:B(!0,1),identity:B(!0,1)})},Za={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/redeem",method:"POST",a:D({amount:B(!0,2),bucket:B(!0,1),identity_id:B(!0,C)})},$a={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/url",method:"POST",va:"obj",a:D({alias:B(!1,1),campaign:B(!1,
1),channel:B(!1,1),data:B(!1,1),feature:B(!1,1),identity_id:B(!0,C),stage:B(!1,1),tags:B(!1,3),type:B(!1,2),source:B(!1,1)})},ab={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/deepview",U:!0,method:"POST",a:D({campaign:B(!1,1),_t:B(!1,C),channel:B(!1,1),data:B(!0,1),feature:B(!1,1),link_click_id:B(!1,1),open_app:B(!1,4),append_deeplink_path:B(!1,4),stage:B(!1,1),tags:B(!1,3),deepview_type:B(!0,1),source:B(!0,1)})},bb={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/has-app",
method:"GET",a:{browser_fingerprint_id:B(!0,C)}},cb={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:D({event:B(!0,1),metadata:B(!0,0),initial_referrer:B(!1,1)})},db={destination:"https://maephet.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:D({event:B(!0,1),metadata:B(!1,0),initial_referrer:B(!1,1),commerce_data:B(!0,0)})};function E(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.s={},c}}function G(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function eb(a){return"true"===a?!0:"false"===a?!1:a}
...
function rb(a,b,c,d,e){function f(){d.get("use_jsonp")||b.U?pb(a,g,c,b.method,h):qb(a,g,m,b.method,d,h)}function h(a,b,c){a&&0<r&&"5"===(c||"").toString().substring(0,1)?(r--,window.setTimeout(function(){f()},200)):e(a,b)}var l=nb(a,b,c);if(l.error)return e(Error(t({message:l.error,endpoint:b.endpoint,data:c})));var g,m="";"GET"===b.method?g=l.url+"?"+l.data:(g=l.url,m=l.data);var r=2;f()};function I(a){a&&a.parentNode.removeChild(a)}function sb(a,b){a&&!a.className.match(new RegExp("(\\s|^)"+b+"(\\s|$)"))&&(a.className+=" "+b)}function tb(a){var b=document.body;b&&b.className.match(new RegExp("(\\s|^)"+a+"(\\s|$)"))&&(b.className=b.className.replace(new RegExp("(\\s|^)"+a+"(\\s|$)")," "))}function ub(a){var b=new Date;return b.setDate(b.getDate()+a)}
...
d.l)),null);if(0===d.j||!d.j)return g(Error(u("Branch SDK not initialized")),null)}e.unshift(g);b.apply(d,e)})}}function Y(){if(!(this instanceof Y))return kc||(kc=new Y),kc;this.X=sa();this.b=new E(["session","cookie","pojo"]);this.N=new kb;this.g=[];this.P="web2.25.2";this.h=this.j=0;this.l=null}
...
b,this.b,function(a,b){c(a,b)})};function ec(a){var b=H(a.b);return(b=b&&b.referring_link)?b:(a=a.b.get("click_id"))?"https://maephet.link.beta.branch.io/c/"+a:null}function J(a,b,c){for(var d=0;d<a.g.length;d++)a.g[d].event&&a.g[d].event!==b||a.g[d].listener(b,c)}
...
!1;try{a=!!(document.querySelectorAll('*[itemtype^="http://schema.org"]')||[]).length}catch(lb){a=!1}return a}function h(a){var b={sdk:"2.25.2",branch_key:g.i},c=H(g.b)||{},d=H(g.b,!0)||{};d.browser_fingerprint_id&&(b._t=d.browser_fingerprint_id);za()||g.c(Oa,b,function(a,b){a&&(g.h=3,g.l=a.message);b&&(c.browser_fingerprint_id=b)});g.c(bb,{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.h=4,g.l=b.message);b||!d||c.has_app||(c.has_app=!0,jb(g.b,c),J(g,"didDownloadApp"));a&&a(null,
c)})}function l(a){a.link_click_id&&(g.V=a.link_click_id.toString());a.session_id&&(g.H=a.session_id.toString());a.identity_id&&(g.v=a.identity_id.toString());a.link&&(g.W=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,4)?"https://maephet.link.beta.branch.io"+b:b:null}!a.click_id&&a.referring_link&&(a.click_id=xa(a.referring_link));g.D=a.browser_fingerprint_id;return a}var g=this;g.j=1;-1<b.indexOf("key_")?g.i=b:g.O=b;c=c&&"function"===typeof c?{}:c;
var m=H(g.b),r=c&&c.url||String(window.location),q=(c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null)||Aa()||ya(),F=!m||!m.identity_id;g.m=!!g.b.get("branch_view_enabled");if(m&&m.session_id&&!q)jb(g.b,{data:""}),d(),h(e);else{var m={sdk:"2.25.2",branch_key:g.i},U=H(g.b,!0)||{};U.browser_fingerprint_id&&(m._t=U.browser_fingerprint_id);za()?g.c(Na,{link_identifier:q,browser_fingerprint_id:q||U.browser_fingerprint_id,alternative_browser_fingerprint_id:U.browser_fingerprint_id,
...
Y.prototype.sendSMS=X(1,function(a,b,c,d){function e(c){f.c(Qa,{link_url:c,phone:b},function(b){a(b||null)})}var f=this;if("function"===typeof d)d={};else if("undefined"===typeof d||null===d)d={};d.make_new_link=d.make_new_link||!1;c.channel&&"app banner"!==c.channel||(c.channel="sms");var h=ec(f);h&&!d.make_new_link?e(h.substring(h.lastIndexOf("/")+1,h.length)):f.c($a,wa(c),function(b,c){if(b)return a(b);var d=c.url;/(bnc.lt\/|app\.link\/)/.test(d)||(d="https://maephet.link.beta.branch.io/"+Ea(d));
f.c(Pa,{link_url:d,click:"click"},function(b,c){if(b)return a(b);e(c.click_id)})})});
Y.prototype.deepview=X(1,function(a,b,c){var d=this;c||(c={});c.deepview_type="undefined"===typeof c.deepview_type?"deepview":"banner";b.data=w(Ga(),b.data);var e="https://maephet.link.beta.branch.io/a/"+d.i,f=!0,h;for(h in b)b.hasOwnProperty(h)&&"data"!==h&&(f?(e+="?",f=!1):e+="&",e+=encodeURIComponent(h)+"="+encodeURIComponent(b[h]));b=wa(b);if(c.open_app||null===c.open_app||"undefined"===typeof c.open_app)b.open_app=!0;b.append_deeplink_path=!!c.append_deeplink_path;b.deepview_type=c.deepview_type;
(f=ec(d))&&!c.make_new_link&&(b.link_click_id=f.substring(f.lastIndexOf("/")+1,f.length));b.banner_options=c;d.C=ka(this.c,d,ab,b,function(b,c){if(b)return d.B=function(){window.location=e},a(b);"function"===typeof c&&(d.B=c);a(null)});d.C()});
Y.prototype.deepviewCta=X(1,function(a){if("undefined"===typeof this.B)throw Error("Cannot call Deepview CTA, please call branch.deepview() first.");window.event&&(window.event.preventDefault?window.event.preventDefault():window.event.returnValue=!1);J(this,"didDeepviewCTA");this.B();a()});Y.prototype.referrals=X(2,function(a){this.c(Wa,{},a)});Y.prototype.getCode=X(2,function(a,b){b.type="credit";b.creation_source=b.creation_source||2;this.c(Ra,b,a)});
Y.prototype.validateCode=X(1,function(a,b){this.c(Sa,{code:b},a)});Y.prototype.applyCode=X(1,function(a,b){this.c(Ta,{code:b},a)});Y.prototype.credits=X(2,function(a){this.c(Ya,{branch_key:this.i,identity:this.S},a)});Y.prototype.creditHistory=X(2,function(a,b){this.c(Xa,b||{},a)});Y.prototype.redeem=X(1,function(a,b,c){this.c(Za,{amount:b,bucket:c},function(b){a(b||null)})});Y.prototype.addListener=function(a,b){"function"===typeof a&&void 0===b&&(b=a);b&&this.g.push({listener:b,event:a||null})};
Y.prototype.removeListener=function(a){a&&(this.g=this.g.filter(function(b){if(b.listener!==a)return b}))};function lc(a,b,c){c=c||{};try{a.A=p(t(c))}finally{a.A=a.A||{}}b()}Y.prototype.setBranchViewData=X(1,function(a,b){lc.call(null,this,a,b)});Y.prototype.closeJourney=X(1,function(a){var b=this;b.renderQueue(function(){if(Ob&&Pb)J(b,"didCallJourneyClose",{banner_id:K}),Zb(Ob);else return a("Journey already dismissed.")});a()});
